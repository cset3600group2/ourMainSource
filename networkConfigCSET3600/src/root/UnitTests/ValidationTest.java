...
public class ValidationTest {
    public static void main(String[] args) {
        ...
        System.out.println("ValidationTest 0: Valiation.isValidInterfacePair(), (expected: all succeed)");
        ...
        if (test == false)
            System.err.println("ValidationTest 0 failed (expected: all succeed).");
        else
            System.out.println("ValidationTest 0 succeeded. (expected: all succeed)");

        // Scenario: VM B is not in the correct subnet for the hub.
        test = false;
        System.out.println("ValidationTest 1: Valiation.isValidInterfacePair(), (expected: all failed)");
        ...
        if (test == true)
            System.err.println("ValidationTest 1 failed. (expected: all failed).");
        else
            System.out.println("ValidationTest 1 succeeded. (expected: all failed)");
        ...
        test = false;
        System.out.println("ValidationTest 2: Valiation.isValidNetwork(), (expected: succeed)");
