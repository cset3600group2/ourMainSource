...
public class Test  {
    public static void main(String[] args) {
        ...
        String fileContents = ConfigFile.writeFile(controller,".\\test.cfg");
        //System.out.print(fileContents);

        //Read the config we just wrote
        controller = ConfigFile.readFile(".\\test.cfg");
        //Write it again to make sure it's still good
        String fileContents2 = ConfigFile.writeFile(controller, ".\\test.cfg");
